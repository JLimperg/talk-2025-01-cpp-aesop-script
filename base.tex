...
\begin{frame}
  ...
  Script steps can now contain \emph{multiple tactic syntaxes} $t₁, ..., tₙ$, e.g.
  \begin{itemize}
  ...
  Use the \emph{first} tactic $tᵢ$ such that $tᵢ$, when run in the step's pre-state, produces the step's post-state.
